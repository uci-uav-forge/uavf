...
def sweep(coords, width, flip_path = False):
    ox = []
    oy = []
    waypoints = []
...
def main():  # pragma: no cover
    ...
    #sweep([[0.0, 0.0], [20.0, -80.0], [50.0, 0.0], [200.0, 30.0], [130.0, 60.0], [40.0, 80.0]], 12.0)
    sweep([[0.0, 0.0], [20.0, -20.0], [50.0, 0.0], [100.0, 30.0], [130.0, 60.0], [40.0, 80.0]], 12.0)
