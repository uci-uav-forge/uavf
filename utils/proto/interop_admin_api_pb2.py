...
# source: interop_admin_api.proto
...
OdlcReview = _reflection.GeneratedProtocolMessageType('OdlcReview', (_message.Message,), dict(
  ...
  __module__ = 'interop_admin_api_pb2'
